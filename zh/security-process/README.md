...
`邮件通知:` 烦请立即发送电子邮件至scy@openharmony.io通知安全问题响应组，以便于安全问题响应组可以启动补丁、发布和公告过程。我们强烈建议您使用[公钥](https://gitee.com/openharmony/security/publicKey/Scy-OpenHarmony_publickey.asc)对邮件进行加密。
