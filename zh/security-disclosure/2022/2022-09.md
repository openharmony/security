...
|OpenHarmony-SA-2022-0905 | CVE-2022-38700 | 多媒体子系统相机服务存在对调用者的权限校验绕过漏洞。 | 攻击者可在局域网内发起攻击，绕过权限管控机制，访问相机服务。| 8.8 |OpenHarmony-v3.1-Release|multimedia_camera_standard|[3.1.x](https://gitee.com/openharmony/multimedia_camera_standard/pulls/247)|本项目组上报|
